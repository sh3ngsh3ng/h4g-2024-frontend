...
export default function Carousel() {
    ...
    return (
        <Container
            bg='#BA333A'
            maxW="50vw"
            h="100vh" // height 100% of parent
            borderRadius="lg"
            p={4}
        >
            <Box h="10%" display="flex" justifyContent="flex-start"> Logo </Box>
            <Box >
                <Text fontSize="64px" lineHeight="94.85px" fontWeight="700" color="white">Come find your VOLUNASIA with us!</Text>
            </Box>
            <Box paddingTop={5} paddingBottom={10}>
                <Text fontSize="32px" lineHeight="40.22px" fontWeight="400" color="white">VOLUNASIA is that moment when you forget you're volunteering to help change lives, because it's changing yours</Text>
            </Box>
